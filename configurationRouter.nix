...
in
{
  ...
  networking.hostName = "NixOSRouter"; # Define your hostname.

   networking.enable = true;

  # --- Interface Configuration (Example: eth0) ---
  networking.interfaces.eth0 = { # <-- Replace 'eth0' with your actual interface name
    useDHCP = true; # 1. Disable DHCP for this interface
